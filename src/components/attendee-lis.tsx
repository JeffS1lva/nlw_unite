              ...
              return (
                <tr key={i} className="border-b border-white/10 hover:bg-white/5">
                  <td className="py-3 px-4 text-sm text-zinc-300">
                    <input type="checkbox" className="size-4 bg-black/20 rounded border border-white/10 checked:accent-orange-400 cursor-pointer" />
                  </td>
                  <td className="py-3 px-4 text-sm text-zinc-300">12890</td>
                  <td className="py-3 px-4 text-sm text-zinc-300">
